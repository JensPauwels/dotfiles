        ...
        switch (node.type) {
            case 'VariableDeclaration':
                ...
                if (init && init.type === 'ArrowFunctionExpression') {
                    docs.push(__assign(__assign({}, variables_1.getVariableDoc(node.declarations[0], lines)), { start: start,
                        end: end }));
                }
                break;
            ...
            case 'ExportDefaultDeclaration':
                switch (node.declaration.type) {
                    ...
                    case 'FunctionDeclaration':
                        docs.push(__assign(__assign({}, functions_1.getFunctionDoc(node.declaration, lines)), { start: start,
                            end: end }));
                        break;
                    default:
                ...
                switch (node.declaration.type) {
                    ...
                    case 'VariableDeclaration':
                        ...
                        if (init_1 && init_1.type === 'ArrowFunctionExpression') {
                            docs.push(__assign(__assign({}, variables_1.getVariableDoc(declaration_2.declarations[0], lines)), { start: start,
                                end: end }));
                        }
                        break;
                    case 'FunctionDeclaration':
                    ...
                    case 'TSInterfaceDeclaration':
                        ...
                        docs.push(__assign(__assign({}, interfaces_1.getInterfaceDoc(node.declaration, lines)), { start: start,
                            end: end }));
                        break;
                }
                break;
